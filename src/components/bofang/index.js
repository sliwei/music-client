    ...
    setTimeout(() => {
      if (nextProps.player.isplay) {
        if (nextProps.singer.singer.length) {
          ...
          message.warn('没有歌曲，请添加喜欢的歌曲在播放列表');
          this.props.pause()
        }
      } else {
      ...
      <div className={css.control}>
        <div className={css.progress}>
          ...
          <div className={css.progress_start}>
            ...
            <div style={{left: `calc(${currentTimes}% - 10px)`}} ref="currentTimeIcon" className={css.progress_img}>
        ...
        <div className={css.operation}>
          ...
          <i className={`${css.like} iconfont icon-xihuanfill`}/>
